 ...
 * @typedef {Object}  GlideScopedEvaluator
 */
class GlideScopedEvaluator {
    /**
     ...
     * @param {Object} variables (Optional) A map of variables with name-value pairs. These variables are
     * available to the script during execution of this method.
     * @returns The result of the script execution.
     * @example // For this example, we created a table: "x_app_table" with two columns: "short_description", "test_script"
     ...
     * @example //setting up a record that contains the script to be executed.
     * gr = new GlideRecord('x_app_table');
